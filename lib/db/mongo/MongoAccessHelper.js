...
var MongoAccessHelper = function (mongse, advisorRole) {
  AbstractAccessHelper.apply(this, [this, advisorRole]);
  this.mongoose = mongse;
  /**
   *
  ...
  this.getPermittedFields = async function (tableName, userAdvisor) {
    tblSchema = this.mongoose.model(tableName).schema;
    let fields = {},
