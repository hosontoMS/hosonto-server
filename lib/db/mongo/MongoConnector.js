...
var Intrface = require("../generic/interface.js");
var BaseConnector = require("../generic/BaseConnector.js");
var log = require("../../log/")(module, "dev_messages.log");
var util = require("util");
let config = require("../../config/");
let mongoose = require("mongoose");

var MongoConnector = function (server1, mongoose, connOptions, dbHelper) {
  ...
  this.find = async function (
    ...
    //   // Only context, query, fields, and Callbacks are supplied
    //   // for use with the default(implied) table
    //   this.findDefault(tableName, query, fields, arguments[3]);
    // } else
    // {
